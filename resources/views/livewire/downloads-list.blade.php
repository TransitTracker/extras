                        ...
                        <a download="{{ basename($file) }}" href="{{ \Illuminate\Support\Facades\Storage::url($file) }}"
                           title="{{ basename($file) }}">
                            ...
                            <svg class="ml-2 w-6 h-6 float-right" fill="currentColor" viewBox="0 0 24 24">
                                <path fill="currentColor" d="@if(strpos($file, '.zip') !== false) M20,6A2,2 0 0,1 22,8V18A2,2 0 0,1 20,20H4C2.89,20 2,19.1 2,18V6C2,4.89 2.89,4 4,4H10L12,6H20M19.25,13H16V9H14V13H10.75L15,17.25 @else M5,20H19V18H5M19,9H15V3H9V9H5L12,16L19,9Z @endif"></path>
                            </svg>
                        </a>
                    </li>
                @endforeach
