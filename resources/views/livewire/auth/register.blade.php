...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <a href="{{ route('home') }}">
            <x-logo class="w-auto h-16 mx-auto text-primary-500" />
        </a>
            ...
            <form wire:submit.prevent="register">
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 leading-5">
                        Name
                        <span class="float-right text-gray-500 text-xs">This name will appear on the contributors page</span>
                    </label>
                ...
                <div class="mt-6">
                    <span class="block w-full rounded-md shadow-sm">
                        <button type="submit" class="flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-primary-500 border border-transparent rounded-md hover:bg-primary-400 focus:outline-none focus:border-primary-600 focus:shadow-outline-primary active:bg-primary-600 transition duration-150 ease-in-out">
                            Register
                        </button>
                    </span>
                </div>
