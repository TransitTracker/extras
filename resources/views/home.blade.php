...
@section('content')
    <div class="flex flex-col md:flex-row h-full bg-secondary-200">
        ...
        <a href="https://transittracker.ca/?pk_campaign=extras" class="block absolute bottom-3 md:bottom-8 left-16 md:left-24">
            <svg class="w-12 h-12 py-1" viewBox="0 0 295.012 403.722">
                <path fill="#2374ab" stroke="#2374ab" stroke-width="3.75" d="M293.137 147.506c0-80.34-65.291-145.631-145.631-145.631S1.875 67.166 1.875 147.506c0 84.709 87.864 198.786 126.942 245.631 9.708 11.651 27.427 11.651 37.136 0 39.32-46.845 127.184-160.922 127.184-245.631z"/>
                <path fill="#fff" d="M84.348 183.032c0 6.948 3.079 13.185 7.895 17.527v10.105a11.826 11.826 0 0011.842 11.842 11.826 11.826 0 0011.842-11.842v-3.947h63.158v3.947c0 6.474 5.289 11.842 11.842 11.842 6.474 0 11.842-5.289 11.842-11.842v-10.105c4.816-4.342 7.895-10.579 7.895-17.527v-78.947c0-27.632-28.263-31.579-63.158-31.579-34.895 0-63.158 3.947-63.158 31.579zm27.632 7.895a11.826 11.826 0 01-11.842-11.842 11.826 11.826 0 0111.842-11.842 11.826 11.826 0 0111.842 11.842c0 6.553-5.29 11.842-11.842 11.842zm71.052 0a11.826 11.826 0 01-11.842-11.842c0-6.553 5.29-11.842 11.842-11.842a11.826 11.826 0 0111.842 11.842 11.826 11.826 0 01-11.842 11.842zm11.842-47.368h-94.736v-39.474h94.736z"/>
            </svg>
        </a>
        <div class="flex-1 p-3 md:p-8 mt-20 md:mt-16 flex">
            <h1 class="text-3xl md:text-6xl font-bold my-auto text-center md:text-left">
        ...
        <div class="flex-1 md:mt-16 flex justify-center items-start md:items-center">
            <div class="bg-primary-500 overflow-hidden text-white shadow-lg rounded-lg">
                <a class="flex items-center justify-between p-3 md:p-8 border-b border-white hover:bg-primary-600 transition-colors duration-200 ease-in-out" href="{{ route('trips') }}">
                ...
                <a class="flex items-center justify-between p-3 md:p-8 border-b border-white hover:bg-primary-600 transition-colors duration-200 ease-in-out" href="{{ route('stops') }}">
                    <h2 class="text-xl md:text-3xl font-bold">Stops</h2>
                    <svg fill="currentColor" class="ml-12 w-6 md:w-12 h-6 md:h-12" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" />
                    </svg>
                </a>
                <a class="flex items-center justify-between p-3 md:p-8 hover:bg-primary-600 transition-colors duration-200 ease-in-out" href="{{ route('downloads') }}">
